    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="typography.html">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-pencil')}}"></use>
            </svg> Typography</a></li>
        <li class="nav-title">Components</li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-puzzle')}}"></use>
            </svg> Base</a>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-cursor')}}"></use>
            </svg> Buttons</a>
          <ul class="nav-group-items">
        ...
        <li class="nav-item"><a class="nav-link" href="charts.html">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-chart-pie')}}"></use>
            </svg> Charts</a></li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-notes')}}"></use>
            </svg> Forms</a>
          <ul class="nav-group-items">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-star')}}"></use>
            </svg> Icons</a>
          <ul class="nav-group-items">
        ...
        <li class="nav-item"><a class="nav-link" href="widgets.html">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-calculator')}}"></use>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items">
            ...
            <li class="nav-item"><a class="nav-link" href="404.html" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-bug')}}"></use>
                </svg> Error 404</a></li>
        ...
        <li class="nav-item mt-auto"><a class="nav-link" href="https://coreui.io/docs/templates/installation/" target="_blank">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-description')}}"></use>
            </svg> Docs</a></li>
        <li class="nav-item"><a class="nav-link nav-link-danger" href="https://coreui.io/pro/" target="_top">
            <svg class="nav-icon">
              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-layers')}}"></use>
            </svg> Try CoreUI
            ...
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-end pt-0">
                <div class="dropdown-header bg-light py-2">
                  ...
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-task')}}"></use>
                  </svg> Tasks<span class="badge badge-sm bg-danger ms-2">42</span></a><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-comment-square')}}"></use>
                ...
                <div class="dropdown-header bg-light py-2">
                  ...
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-settings')}}"></use>
                  </svg> Settings</a><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-credit-card')}}"></use>
                  </svg> Payments<span class="badge badge-sm bg-secondary ms-2">42</span></a><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-file')}}"></use>
                ...
                <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                  <div>
                    <div class="fs-4 fw-semibold">26K <span class="fs-6 fw-normal">(-12.4%
                        <svg class="icon">
                          <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-arrow-bottom')}}"></use>
                        </svg>)</span></div>
                    <div>Users</div>
                  </div>
                  <div class="dropdown">
                    <button class="btn btn-transparent text-white p-0" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <svg class="icon">
                        <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-options')}}"></use>
                      </svg>
                    </button>
                ...
                <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                  <div>
                    <div class="fs-4 fw-semibold">$6.200 <span class="fs-6 fw-normal">(40.9%
                        <svg class="icon">
                          <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-arrow-top')}}"></use>
                        </svg>)</span></div>
                    <div>Income</div>
                  </div>
                  <div class="dropdown">
              ...
              <div class="d-flex justify-content-between">
                ...
                <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                  ...
                  <button class="btn btn-primary" type="button">
                    <svg class="icon">
                      <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-cloud-download')}}"></use>
                    </svg>
                  </button>
                </div>
              </div>
          ...
          <div class="row">
              ...
              <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                  <svg class="icon icon-3xl text-white my-4">
                    <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-facebook-f')}}"></use>
                  </svg>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card mb-4" style="--cui-card-cap-bg: #00aced">
                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                  <svg class="icon icon-3xl text-white my-4">
                    <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-twitter')}}"></use>
                  </svg>
                  <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card mb-4" style="--cui-card-cap-bg: #4875b4">
                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                  <svg class="icon icon-3xl text-white my-4">
                    <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-linkedin')}}"></use>
                  </svg>
                  <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="progress-group mb-5">
                        <div class="progress-group-header">
                          <svg class="icon icon-lg me-2">
                            <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-user-female')}}"></use>
                          </svg>
                          <div>Female</div>
                      ...
                      <div class="progress-group">
                        <div class="progress-group-header">
                          <svg class="icon icon-lg me-2">
                            <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-google')}}"></use>
                          </svg>
                    ...
                    <table class="table border mb-0">
                      <thead class="table-light fw-semibold">
                        <tr class="align-middle">
                          <th class="text-center">
                            <svg class="icon">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/free.svg#cil-people')}}"></use>
                            </svg>
                          </th>
                          <th>User</th>
                      ...
                      <tbody>
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/flag.svg#cif-us')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="clearfix">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard')}}"></use>
                            </svg>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/flag.svg#cif-br')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="clearfix">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-cc-visa')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-medium-emphasis">Last login</div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/flag.svg#cif-in')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="clearfix">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-cc-stripe')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-medium-emphasis">Last login</div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/flag.svg#cif-fr')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="clearfix">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-cc-paypal')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-medium-emphasis">Last login</div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/flag.svg#cif-es')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="clearfix">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-medium-emphasis">Last login</div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/flag.svg#cif-pl')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="clearfix">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('adm/vendors/@coreui/icons/svg/brand.svg#cib-cc-amex')}}"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-medium-emphasis">Last login</div>

<x-base-layout>
		...
		<div class="container">
			<div class="row m-rl--1">
				<div class="col-md-6 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url({{ asset('src/images/post-01.jpg')}} );">
				...
				<div class="col-md-6 p-rl-1">
					<div class="row m-rl--1">
						<div class="col-12 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url({{ asset('src/images/post-02.jpg')}});">
								<a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
						...
						<div class="col-sm-6 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url({{ asset('src/images/post-03.jpg')}});">
								<a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
						...
						<div class="col-sm-6 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url({{ asset('src/images/post-04.jpg')}});">
								<a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
										...
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="m-b-30">
												<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-05.jpg')}}" alt="IMG">
												</a>
										...
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-06.jpg')}}" alt="IMG">
												</a>
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-07.jpg')}}" alt="IMG">
												</a>
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-08.jpg')}}" alt="IMG">
												</a>
								...
								<div class="tab-pane fade" id="tab1-2" role="tabpanel">
									<div class="row">
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="m-b-30">
												<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-09.jpg')}}" alt="IMG">
												</a>
								...
								<div class="tab-pane fade show active" id="tab2-1" role="tabpanel">
									<div class="row">
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="m-b-30">
												<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-10.jpg')}}" alt="IMG">
												</a>
										...
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-11.jpg')}}" alt="IMG">
												</a>
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-12.jpg')}}" alt="IMG">
												</a>
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-13.jpg')}}" alt="IMG">
												</a>
								...
								<div class="tab-pane fade show active" id="tab3-1" role="tabpanel">
									<div class="row">
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="m-b-30">
												<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-14.jpg')}}" alt="IMG">
												</a>
										...
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-15.jpg')}}" alt="IMG">
												</a>
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-16.jpg')}}" alt="IMG">
												</a>
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-17.jpg')}}" alt="IMG">
												</a>
								...
								<div class="tab-pane fade" id="tab3-2" role="tabpanel">
									<div class="row">
										...
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('src/images/post-18.jpg')}}" alt="IMG">
												</a>
				...
				<div class="col-md-10 col-lg-4">
					<div class="p-l-10 p-rl-0-sr991 p-b-20">
						...
						<div class="flex-c-s p-t-8">
							<a href="#">
								<img class="max-w-full" src="{{ asset('src/images/banner-02.jpg')}}" alt="IMG">
							</a>
						</div>
	...
	<div class="container">
		<div class="flex-c-c">
			<a href="#">
				<img class="max-w-full" src="{{ asset('src/images/banner-01.jpg')}}" alt="IMG">
			</a>
		</div>
	</div>
				...
				<div class="col-md-10 col-lg-8 p-b-20">
					...
					<div class="row p-t-35">
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="{{ asset('src/images/latest-01.jpg')}}" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="{{ asset('src/images/latest-02.jpg')}}" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="{{ asset('src/images/latest-03.jpg')}}" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="{{ asset('src/images/latest-04.jpg')}}" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="{{ asset('src/images/latest-05.jpg')}}" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="{{ asset('src/images/latest-06.jpg')}}" alt="IMG">
								</a>
						...
						<div class="p-b-55">
							...
							<div>
								<div class="wrap-pic-w pos-relative">
									<img src="{{ asset('src/images/video-01.jpg')}}" alt="IMG">
